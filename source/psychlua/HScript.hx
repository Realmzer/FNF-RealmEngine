...
class HScript extends SScript
{
	...
	override function preset() {
		...
		set('Limo', states.stages.Limo);
		set('Mall', states.stages.Mall);
		set('MallEvil', states.stages.MallEvil);
		set('Philly', states.stages.Philly);
		set('School', states.stages.School);
		set('SchoolEvil', states.stages.SchoolEvil);
		set('Spooky', states.stages.Spooky);
		set('StageWeek1', states.stages.StageWeek1);
		set('Tank', states.stages.Tank);
		//set('Template', states.stages.Template);
		set('BackgroundDancer', states.stages.objects.BackgroundDancer);
		set('BackgroundGirls', states.stages.objects.BackgroundGirls);
		set('BackgroundTank', states.stages.objects.BackgroundTank);
		set('DadBattleFog', states.stages.objects.DadBattleFog);
		set('MallCrowd', states.stages.objects.MallCrowd);
		set('PhillyGlowGradient', states.stages.objects.PhillyGlowGradient);
		set('PhillyGlowParticle', states.stages.objects.PhillyGlowParticle);
		set('PhillyTrain', states.stages.objects.PhillyTrain);
		set('TankmenBG', states.stages.objects.TankmenBG);
