...
class Flixel3DPlaceholder extends FlxView3D
{
	// Mesh
	...
	public function new(x:Float = 0, y:Float = 0, width:Int = -1, height:Int = -1)
	{
		...
		material = new TextureMaterial(Cast.bitmapTexture("assets/3D/Flixel Color.png"));
		material.lightPicker = lightPicker;

		var __flixelModel = Assets.getBytes("assets/3D/flixel.obj");
		assetLoaderContext.mapUrlToData("flixel.mtl", Assets.getBytes("assets/3D/flixel.mtl"));
