...
class MainMenuState extends MusicBeatState
{
	...
	public static var realmEngineVersion:String = '1.0.0';
	...
	override function create()
	{
		...
		DiscordAPI.changePresence("In the Main Menu", null);
		#end
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('menuGrad'));
